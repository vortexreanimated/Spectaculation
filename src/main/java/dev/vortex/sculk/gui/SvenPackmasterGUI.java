	...
	public void onOpen(GUIOpenEvent e) {
		...
		set(new GUIClickableItem() {
			...
			public ItemStack getItem() {
				return SUtil.getStack(SlayerBossType.SVEN_PACKMASTER_I.getDisplayName(),
						SlayerBossType.SVEN_PACKMASTER_I.getType().getIcon(), (short) 0, 1,
						SlayerBossType.SVEN_PACKMASTER_I.asLore(true));
			}
		...
		set(new GUIClickableItem() {
			...
			@Override
			public ItemStack getItem() {
				return SUtil.getStack(SlayerBossType.SVEN_PACKMASTER_II.getDisplayName(),
						SlayerBossType.SVEN_PACKMASTER_II.getType().getIcon(), (short) 0, 1,
						SlayerBossType.SVEN_PACKMASTER_II.asLore(true));
			}
		...
		set(new GUIClickableItem() {
			...
			@Override
			public ItemStack getItem() {
				return SUtil.getStack(SlayerBossType.SVEN_PACKMASTER_III.getDisplayName(),
						SlayerBossType.SVEN_PACKMASTER_III.getType().getIcon(), (short) 0, 1,
						SlayerBossType.SVEN_PACKMASTER_III.asLore(true));
			}
		...
		set(new GUIClickableItem() {
			...
			@Override
			public ItemStack getItem() {
				return SUtil.getStack(SlayerBossType.SVEN_PACKMASTER_IV.getDisplayName(),
						SlayerBossType.SVEN_PACKMASTER_IV.getType().getIcon(), (short) 0, 1,
						SlayerBossType.SVEN_PACKMASTER_IV.asLore(true));
			}
