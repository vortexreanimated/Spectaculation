...
public class EnchantmentType {
	...
	public static final EnchantmentType GROWTH = new EnchantmentType("Growth", "growth", "Applies %s Health.",
	...
	public static final EnchantmentType POWER = new EnchantmentType("Power", "power", "Increases bow damage by %s%.",
			SpecificItemType.BOW);
	...
	public static final EnchantmentType ULTIMATE_WISE = new EnchantmentType("Ultimate Wise", "ultimate_wise",
			"Reduces the Mana Cost of this item's ability by %s%.", true, SpecificItemType.SWORD,
			SpecificItemType.SHOVEL, SpecificItemType.SHEARS, SpecificItemType.PICKAXE, SpecificItemType.BOW,
			SpecificItemType.AXE, SpecificItemType.ROD, SpecificItemType.HOE, SpecificItemType.HELMET,
			SpecificItemType.CHESTPLATE, SpecificItemType.LEGGINGS, SpecificItemType.BOOTS);
	...
	public static final EnchantmentType BANE_OF_ARTHROPODS = new EnchantmentType("Bane of Arthropods",
			"bane_of_arthropods", "Increases damage dealt to Cave Spiders, Spiders, and Silverfish by %s% per level.",
			SpecificItemType.SWORD, SpecificItemType.AXE);
	...
	public static final EnchantmentType HARVESTING = new EnchantmentType("Harvesting", "harvesting",
			"Increases the chance for crops to drop double the amount of items by %s%.", SpecificItemType.HOE);
	...
	public EnchantmentType(String name, String namespace, String description, boolean ultimate, Enchantment vanilla,
			SpecificItemType... compatibleTypes) {
		this.name = name;
	...
	public EnchantmentType(String name, String namespace, String description, boolean ultimate,
			SpecificItemType... compatibleTypes) {
		this(name, namespace, description, ultimate, null, compatibleTypes);
	}

	public EnchantmentType(String name, String namespace, String description, Enchantment vanilla,
			SpecificItemType... compatibleTypes) {
