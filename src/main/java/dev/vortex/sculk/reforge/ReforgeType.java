...
public enum ReforgeType {
	OVERPOWERED(OverpoweredReforge.class, false), SUPERGENIUS(SupergeniusReforge.class, false), SPICY(
			SpicyReforge.class), FIERCE(
					FierceReforge.class), HEROIC(HeroicReforge.class), ODD(OddReforge.class), RAPID(RapidReforge.class);
