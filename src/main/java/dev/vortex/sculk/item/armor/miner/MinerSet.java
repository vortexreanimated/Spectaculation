...
public class MinerSet implements TickingSet {
	...
	@Override
	public void tick(Player owner, SItem helmet, SItem chestplate, SItem leggings, SItem boots,
		...
		if ((action == null || (action.getTimeStamp() + 8000 <= System.currentTimeMillis() && helmet != null
				&& chestplate != null && leggings != null && boots != null)) && counters.getFirst().get() >= 2) {
