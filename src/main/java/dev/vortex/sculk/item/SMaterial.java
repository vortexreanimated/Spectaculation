...
import dev.vortex.sculk.item.armor.BigBounceBoots;
import dev.vortex.sculk.item.armor.ObsidianChestplate;
import dev.vortex.sculk.item.armor.SpidersBoots;
import dev.vortex.sculk.item.armor.hardened.*;
import dev.vortex.sculk.item.armor.lapis.*;
import dev.vortex.sculk.item.armor.miner.*;
import dev.vortex.sculk.item.armor.vanilla.chainmail.ChainmailBoots;
import dev.vortex.sculk.item.armor.vanilla.chainmail.ChainmailChestplate;
import dev.vortex.sculk.item.armor.vanilla.chainmail.ChainmailHelmet;
import dev.vortex.sculk.item.armor.vanilla.chainmail.ChainmailLeggings;
import dev.vortex.sculk.item.armor.vanilla.diamond.DiamondBoots;
import dev.vortex.sculk.item.armor.vanilla.diamond.DiamondChestplate;
import dev.vortex.sculk.item.armor.vanilla.diamond.DiamondHelmet;
import dev.vortex.sculk.item.armor.vanilla.diamond.DiamondLeggings;
import dev.vortex.sculk.item.armor.vanilla.golden.GoldenBoots;
import dev.vortex.sculk.item.armor.vanilla.golden.GoldenChestplate;
import dev.vortex.sculk.item.armor.vanilla.golden.GoldenHelmet;
import dev.vortex.sculk.item.armor.vanilla.golden.GoldenLeggings;
import dev.vortex.sculk.item.armor.vanilla.iron.IronBoots;
import dev.vortex.sculk.item.armor.vanilla.iron.IronChestplate;
import dev.vortex.sculk.item.armor.vanilla.iron.IronHelmet;
import dev.vortex.sculk.item.armor.vanilla.iron.IronLeggings;
import dev.vortex.sculk.item.armor.vanilla.leather.LeatherBoots;
import dev.vortex.sculk.item.armor.vanilla.leather.LeatherChestplate;
import dev.vortex.sculk.item.armor.vanilla.leather.LeatherHelmet;
import dev.vortex.sculk.item.armor.vanilla.leather.LeatherLeggings;
import dev.vortex.sculk.item.axe.vanilla.*;
import dev.vortex.sculk.item.bow.Bow;
import dev.vortex.sculk.item.bow.EndStoneBow;
import dev.vortex.sculk.item.bow.HurricaneBow;
import dev.vortex.sculk.item.bow.MosquitoBow;
import dev.vortex.sculk.item.dragon.old.*;
import dev.vortex.sculk.item.dragon.protector.*;
import dev.vortex.sculk.item.dragon.strong.*;
import dev.vortex.sculk.item.dragon.superior.*;
import dev.vortex.sculk.item.dragon.unstable.*;
import dev.vortex.sculk.item.dragon.wise.*;
import dev.vortex.sculk.item.dragon.young.*;
import dev.vortex.sculk.item.enchanted.*;
import dev.vortex.sculk.item.enchanting.EnchantedBook;
import dev.vortex.sculk.item.entity.RevenantHorrorHead;
import dev.vortex.sculk.item.exclusive.TestItem;
import dev.vortex.sculk.item.exclusive.WheatCrystal;
import dev.vortex.sculk.item.farming.*;
import dev.vortex.sculk.item.foraging.*;
import dev.vortex.sculk.item.hoe.vanilla.*;
import dev.vortex.sculk.item.mining.*;
import dev.vortex.sculk.item.oddities.*;
import dev.vortex.sculk.item.orb.*;
import dev.vortex.sculk.item.pet.EndermanPet;
import dev.vortex.sculk.item.pet.GungaPet;
import dev.vortex.sculk.item.pickaxe.vanilla.*;
import dev.vortex.sculk.item.revenant.*;
import dev.vortex.sculk.item.rune.*;
import dev.vortex.sculk.item.shovel.vanilla.*;
import dev.vortex.sculk.item.storage.*;
import dev.vortex.sculk.item.sven.*;
import dev.vortex.sculk.item.tarantula.*;
